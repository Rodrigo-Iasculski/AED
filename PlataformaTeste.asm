...
loop:
	...
	beq  $t8, 4, diagonalEsqBaixo
	beq  $t8, 5, diagonalEsqBaixoTopo
	beq  $t8, 6, diagonalDir
	beq  $t8, 7, diagonalDirBaixo
...
diagonalDir:
	...
	lw   $t0, 0($s5) 
	lw   $t1, cinza
	beq  $t0, $t1, diagonalDirBaixoTopo   #ver quando ta no topo tannto no esq e no dir
